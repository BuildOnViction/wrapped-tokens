...
import { WrappedMEW } from '../typechain-types';
...
describe('WrappedMEW token', async function() {
  ...
  before(async function() {
    ...
    const tokenFactory = await hhe.ethers.getContractFactory('WrappedMEW');
...
async function createPermit(token: WrappedMEW, owner: Signer, spenderAddress: string, amount: BigNumber, deadline: BigNumber): Promise<ECDSASignature> {
